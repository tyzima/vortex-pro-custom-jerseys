...
export const ProductDesignCanvas: React.FC<ProductDesignCanvasProps> = ({
  ...
  return (
    <div className="h-full bg-neutral-950 flex flex-col">
      ...
      <div
        className={`absolute top-14 left-0 right-0 bg-neutral-900 border-b border-neutral-700 shadow-2xl z-40 transform transition-all duration-300 ease-out ${
          showProductDetailsModal ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0 pointer-events-none'
        }`}
      >
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex-1 grid grid-cols-4 gap-3">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-black border border-neutral-700 rounded text-sm text-white focus:border-brand-accent outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-neutral-500 uppercase mb-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-black border border-neutral-700 rounded text-sm text-white placeholder-neutral-600 focus:border-brand-accent outline-none"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-neutral-500 uppercase mb-1">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  {productDetails.features.map((feature, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-1.5 px-2 py-1 bg-black border border-neutral-700 rounded text-xs text-white"
                    >
                      <span>{feature}</span>
                      <button
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-1.5 bg-black border border-neutral-700 rounded text-xs text-white placeholder-neutral-600 focus:border-brand-accent outline-none"
                    onKeyDown={(e) => e.key === 'Enter' && addFeature()}
                  />
                  <button
                    onClick={addFeature}
                    disabled={!newFeature.trim()}
                    className="px-3 py-1.5 bg-neutral-800 text-white font-bold uppercase text-xs rounded hover:bg-neutral-700 transition-colors disabled:opacity-50"
                  >
                    Add
                  </button>
                </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-neutral-800">
                <button
                  ...
                  className="px-4 py-2 text-neutral-400 hover:text-white font-bold uppercase text-xs transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-brand-accent text-black font-bold uppercase text-xs rounded hover:bg-brand-accent/90 transition-colors disabled:opacity-50 flex items-center gap-2"
                >
                  {savingProductDetails && <Loader2 size={14} className="animate-spin" />}
                  Save Changes
                </button>
              </div>
            </div>
