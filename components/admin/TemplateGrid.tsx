          ...
          <div className="flex items-center justify-between mb-2">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                {sportLabel} {cutLabel} {garmentType === 'jersey' ? 'Jerseys' : 'Shorts'}
              </h1>
              <p className="text-gray-600 mt-1">
                Manage design templates for this garment
              </p>
            </div>
            <button
          ...
          <div className="bg-white rounded-xl border-2 border-dashed border-gray-300 p-12 text-center">
            <div className="max-w-sm mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Create your first template to get started with custom designs for this garment.
              </p>
              <button
                onClick={onCreateTemplate}
              ...
              >
                <div className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <svg viewBox="0 0 400 500" className="w-32 h-40">
                      {garmentType === 'jersey' ? (
                        <path
